...
def build_summary(requirement: Dict[str, Any]) -> Dict[str, Any]:
    ...
    service_desc = requirement.get("service_desc", {})
    service_type = requirement.get("service_type", {})
    equipment_name = requirement.get("equipment_name", {})
    equipment_model = requirement.get("equipment_model", {})
    business_type = requirement.get("business_type", {})
    service_location_type = requirement.get("service_location_type", {})
    equipment_unit = requirement.get("equipment_unit", {})
